...
import ProjectForm, { projectSchema } from '@/components/ProjectForm/ProjectForm'
...
export default function UpdateProjectForm({projectId} : { projectId: string }) {
  ...
  return (
        ...
        Define the scope and foundational details of your project.              </p>
            </div>
    
               <ProjectForm  onSubmit={onSubmit} buttonText="Save Change" isLoading={isLoading} onBack={() => router.back()}/>
          </div>
        </div>
  )
}
