    ...
    <div className="border-t border-slate-100 pt-5">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link href={`/project/${projectId}/tasks/new?epicId=${epic.id}`}>
          <button onClick={() => onAddTask?.(projectId, epic.id)} className=" cursor-pointer text-sm font-semibold text-[#0A52C5] flex items-center gap-1 hover:text-blue-800 transition-colors">
